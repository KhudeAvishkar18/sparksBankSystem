...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1">
              ...
              <!-- <div class="col-sm-12 col-md img text-center">
                <img src="img/bankImage.png" class="img-fluid pt-2">
              </div> -->
            </div>
      ...
      <!-- <footer class="text-center mt-5 py-2 min-vh-50">
        <p>&copy 2023 Made by <b>Avishkar Khude</b> <br>The Sparks Foundation</p>
      </footer> -->
